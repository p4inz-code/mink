...
impl<'a> Lowerer<'a> {
    ...
    fn runtime_service(name: &str) -> Option<RuntimeService> {
        let service = match name {
            ...
            "rt_int_to_float" => RuntimeService::IntToFloat,
            "rt_float_to_int" => RuntimeService::FloatToInt,
            "rt_fs_read" => RuntimeService::FsRead,
            "rt_fs_write" => RuntimeService::FsWrite,
            "rt_fs_exists" => RuntimeService::FsExists,
            "rt_fs_file_size" => RuntimeService::FsFileSize,
            "rt_fs_create_dir" => RuntimeService::FsCreateDir,
            "rt_fs_remove_dir" => RuntimeService::FsRemoveDir,
            "rt_fs_remove_file" => RuntimeService::FsRemoveFile,
            "rt_fs_copy" => RuntimeService::FsCopy,
            ...
            // --- Process (Session 59) ---
            "rt_process_run" => RuntimeService::ProcessRun,
            "rt_process_stdout" => RuntimeService::ProcessStdout,
            "rt_process_stderr" => RuntimeService::ProcessStderr,
            "rt_process_stdout_len" => RuntimeService::ProcessStdoutLen,
            "rt_process_stderr_len" => RuntimeService::ProcessStderrLen,
            "rt_process_id" => RuntimeService::ProcessId,
            "rt_time_now" => RuntimeService::TimeNow,
            "rt_time_millis" => RuntimeService::TimeMillis,
            "rt_time_ticks" => RuntimeService::TimeTicks,
            "rt_time_freq" => RuntimeService::TimeFreq,
            "rt_time_filetime" => RuntimeService::TimeFiletime,
            ...
            "rt_net_wsa_last_error" => RuntimeService::NetWsaLastError,
            "rt_net_socket" => RuntimeService::NetSocket,
            "rt_net_connect" => RuntimeService::NetConnect,
            "rt_net_bind" => RuntimeService::NetBind,
            "rt_net_listen" => RuntimeService::NetListen,
            "rt_net_accept" => RuntimeService::NetAccept,
            "rt_net_send" => RuntimeService::NetSend,
            "rt_net_recv" => RuntimeService::NetRecv,
            "rt_net_close" => RuntimeService::NetClose,
            "rt_net_shutdown" => RuntimeService::NetShutdown,
            "rt_sys_load_lib" => RuntimeService::SysLoadLib,
            "rt_sys_get_proc" => RuntimeService::SysGetProc,
            "rt_sys_call" => RuntimeService::SysCall,
            "rt_sys_load64" => RuntimeService::SysLoad64,
            "rt_sys_load32" => RuntimeService::SysLoad32,
            "rt_net_getaddrinfo" => RuntimeService::NetGetAddrInfo,
            "rt_net_freeaddrinfo" => RuntimeService::NetFreeAddrInfo,
            "rt_net_gethostname" => RuntimeService::NetGetHostName,
            "rt_net_htons" => RuntimeService::NetHtons,
            // --- Crypto (Session 71) ---
            "rt_crypto_init" => RuntimeService::CryptoInit,
